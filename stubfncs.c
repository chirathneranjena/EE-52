...
unsigned char  update(unsigned char far *p, int n)
{
    return  FALSE;
}
...
void  display_track(unsigned int t)
{
    return;
}
...
int  get_blocks(unsigned long int b, int n, unsigned char far *p)
{
    return  n;
}
...
void  audio_play(unsigned char far *p, int n)
{
    return;
}
